...
class PokemonsControllerIT {
    ...
    @Test
    void deveRetornarTodosOsPokemons() throws Exception {
    ...
    @Test
    void deveRetornarPokemonQuandoIdExiste() throws Exception {
    ...
    @Test
    void deveRetornarVazioQuandoIdNaoExiste() throws Exception {
    ...
    @Test
    void deveCriarNovoPokemon() throws Exception {
        String novoPokemon = """
                {
                    "nome": "Squirtle",
                    "tipo": "Água",
    ...
    @Test
    void deveAtualizarPokemon() throws Exception {
    ...
    @Test
    void deveDeletarPokemon() throws Exception {
        mockMvc.perform(delete("/atv/pokemons/1"))
                .andExpect(status().isOk())
                .andExpect(content().string("Pokemon 1 removido"));
    }
